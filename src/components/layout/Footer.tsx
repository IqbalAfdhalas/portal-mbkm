            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3 text-sm">
                ...
                <span className="text-gray-300 font-body">
                  Jl. Ampera Raya No.7, Jakarta Selatan, DKI Jakarta 12560
                </span>
              </li>
              <li className="flex items-start space-x-3 text-sm">
                <svg
                ...
                <span className="text-gray-300 font-body">info@anri.go.id</span>
              </li>
              <li className="flex items-start space-x-3 text-sm">
                <svg
                  className="h-5 w-5 text-secondary flex-shrink-0 mt-0.5"
                ...
                <span className="text-gray-300 font-body">(021) 7805851</span>
              </li>
            </ul>
          </div>
        </div>
