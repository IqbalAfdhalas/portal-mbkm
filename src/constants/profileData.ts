...
export const profileData: ProfileType[] = [
  ...
  },
  {
    ...
    bioSingkat:
      'Profesor di bidang sistem informasi kearsipan dengan fokus pada pengembangan aplikasi arsip digital.',
  },
  {
    id: 'pk003',
    ...
    bioSingkat:
      'Dosen senior bidang ilmu komunikasi dengan spesialisasi manajemen informasi organisasi.',
  },
  {
    id: 'pk004',
    ...
    github: 'ekosaputra',
    bioSingkat:
      'Peneliti dan pengembang aplikasi sistem kearsipan berbasis web dengan fokus pada aksesibilitas.',
  },
  {
    id: 'pk005',
    ...
    prodi: 'Perpustakaan', // Added prodi field
    ...
    bioSingkat:
      'Pakar perpustakaan digital dengan keahlian dalam sistem temu kembali informasi dan manajemen metadata.',
  },
  ...
  // Mentor BAST ANRI
  {
    ...
    unit: 'Pengolahan', // Added unit field
    ...
    bioSingkat:
      'Kepala bidang Pengelolaan Arsip Statis dengan pengalaman lebih dari 12 tahun di ANRI.',
  },
  {
    id: 'mn002',
    ...
    unit: 'Preservasi', // Added unit field
    ...
    bioSingkat:
      'Pengembang aplikasi dan sistem kearsipan digital di BAST ANRI dengan fokus pada pengalaman pengguna.',
  },
  {
    id: 'mn003',
    ...
    unit: 'Akuisisi', // Added unit field
    ...
    bioSingkat:
      'Praktisi arsip dengan spesialisasi pada penyusunan kebijakan dan standar kearsipan nasional.',
  },
  {
    id: 'mn004',
    ...
    unit: 'Pelayanan', // Added unit field
    ...
    bioSingkat:
      'Spesialis komunikasi visual dan publikasi di bidang kearsipan dengan fokus pada penyebarluasan informasi arsip.',
  },
  {
    id: 'mn005',
    ...
    unit: 'Tata Usaha', // Added unit field
    ...
    github: 'kurniawanadi',
    bioSingkat:
      'Ahli keamanan data dengan pengalaman 10 tahun dalam pengelolaan sistem informasi kearsipan.',
  },
  ...
  },
  {
    ...
    bioSingkat:
      'Mahasiswa ilmu komunikasi dengan minat pada strategi kehumasan dan publikasi arsip.',
  },
  {
    id: 'mhs004',
    nama: 'Olivia Sanjaya',
    ...
    bioSingkat:
      'Tertarik pada pengintegrasian sistem perpustakaan dan arsip untuk kemudahan akses informasi.',
  },
  ...
  // Angkatan 2023
  {
    ...
    bioSingkat:
      'Pengembang aplikasi mobile dengan minat pada teknologi untuk kemudahan akses arsip digital.',
  },
  {
    id: 'mhs006',
    nama: 'Qori Aulia',
    ...
    bioSingkat:
      'Spesialisasi dalam preservasi dan metadata arsip audio visual dengan pendekatan standar internasional.',
  },
  {
    id: 'mhs007',
    nama: 'Rizky Ramadhan',
    ...
    bioSingkat:
      'Meneliti potensi teknologi blockchain untuk autentikasi dan keamanan arsip digital.',
  },
  {
    id: 'mhs008',
    nama: 'Sari Indah',
    ...
    linkedin: 'sari-indah',
    bioSingkat:
      'Fokus pada program literasi kearsipan dan pengembangan materi edukasi arsip untuk masyarakat umum.',
  },
  ...
  // Angkatan 2024
  {
    ...
    bioSingkat:
      'Content creator yang fokus pada penyebarluasan informasi kearsipan melalui media sosial dan podcast.',
  },
  {
    id: 'mhs010',
    ...
    bioSingkat:
      'Tertarik pada aspek legal dan administratif pengelolaan arsip digital dengan fokus pada aturan retensi.',
  },
  {
    id: 'mhs011',
    nama: 'Vino Aditya',
    ...
    bioSingkat:
      'Pengembang full-stack dengan spesialisasi pada visualisasi data dan analitik sistem kearsipan.',
  },
  {
    id: 'mhs012',
    nama: 'Winda Sari',
    ...
    linkedin: 'winda-sari',
    bioSingkat:
      'UX researcher dengan fokus pada pengembangan antarmuka pengguna yang ramah untuk aplikasi kearsipan.',
  },
  {
    id: 'mhs013',
    nama: 'Xavier Putra',
    ...
    bioSingkat:
      'Peneliti teknologi AI dan machine learning untuk otomatisasi proses klasifikasi dan temu kembali arsip.',
  },
  {
    id: 'mhs014',
    nama: 'Yasmin Aulia',
    ...
    bioSingkat:
      'Fokus pada pengembangan sistem terpadu antara perpustakaan digital dan arsip elektronik.',
  },
  {
    id: 'mhs015',
    nama: 'Zahra Putri',
    ...
    bioSingkat:
      'Desainer komunikasi visual dengan keahlian dalam visualisasi data dan infografis untuk kearsipan.',
  },
];
