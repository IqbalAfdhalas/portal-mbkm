      ...
      <header className="bg-gradient-to-r from-primary to-primary-light dark:from-dark-primary dark:to-primary py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-heading font-bold text-white mb-2">Galeri</h1>
            ...
            <div className="relative w-full md:w-auto md:min-w-[300px]">
              ...
              />
              <FiSearch className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-400" size={18} />
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="md:hidden mb-4">
            ...
            >
              <span className="font-medium">{getCategoryName(selectedCategory) || "Semua Kategori"}</span>
              <FiChevronDown className={`transform transition-transform ${mobileFilterOpen ? "rotate-180" : ""}`} />
            </button>
                  ...
                  {categories.map(category => (
                    <button
                      ...
                      className={`w-full text-left px-5 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 ${
                        selectedCategory === category.id ? "font-medium text-primary-light dark:text-blue-400" : ""
                      }`}
                    >
                      {category.name}
                    </button>
                ...
                >
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {item.type === "photo" ? (
                        <FiImage className="flex-shrink-0 text-gray-500 dark:text-gray-400" size={16} />
                      ) : (
                        <FiVideo className="flex-shrink-0 text-gray-500 dark:text-gray-400" size={16} />
                      )}
                    </div>
