...
export default function LoginPage() {
  ...
  // Don't show login form if checking auth state or already logged in
  if (loading || user) {
    return (
        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary to-primary-light p-12 flex-col justify-center items-center relative overflow-hidden">
          <div className="z-10 text-center">
            <h1 className="text-4xl font-heading font-bold text-white mb-6">
              Portal MBKM BAST ANRI
            </h1>
            <p className="text-lg text-white/90 max-w-md">
              Akses informasi program MBKM, direktori mahasiswa, dan forum
              diskusi dalam satu platform terintegrasi.
            </p>
          </div>
